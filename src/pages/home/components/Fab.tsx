...
export default function Fab() {
  return (
    <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 flex items-center gap-2 px-3 py-2 rounded-full glass-panel border border-primary/30 shadow-[0_0_20px_rgba(226,194,136,0.15)] bg-surface-container/80 backdrop-blur-xl w-[max-content]">
      <a
